    ...
    <div className="pb-20 pt-36">
      ...
      <div className="relative z-10 my-20 flex justify-center">
        <div className="flex max-w-[89vw] flex-col items-center justify-center md:max-w-2xl lg:max-w-[60vw]">
          ...
          <p className="mb-4 text-center text-sm selection:bg-yellow-400 selection:text-black md:text-lg md:tracking-wider lg:text-2xl">
            {"I'm Harshit, AWS Fullstack Developer based in Hyderabad."}
          </p>
